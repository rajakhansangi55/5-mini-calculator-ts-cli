...
if(num1 && num2){
    ...
    if(operator === "Division"){console.log(`\n Answer of ${num1} / ${num2} = ${num1/num2}`)}
    else if(operator === "Multiplication"){console.log(`\n Answer of ${num1} x ${num2} = ${num1*num2}`)}
   else if(operator === "Addition"){console.log(`\n Answer of ${num1} + ${num2} = ${num1+num2}`)}
else if(operator === "Subtraction"){console.log(`\n Answer of ${num1} - ${num2} = ${num1-num2}`)}
